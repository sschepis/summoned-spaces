...
export const ACTION_TYPES = {
  ...
  // Real-time Actions
  REALTIME: {
    WEBSOCKET_CONNECT: 'REALTIME/WEBSOCKET_CONNECT',
    WEBSOCKET_DISCONNECT: 'REALTIME/WEBSOCKET_DISCONNECT',
    WEBSOCKET_ERROR: 'REALTIME/WEBSOCKET_ERROR',
    WEBSOCKET_MESSAGE: 'REALTIME/WEBSOCKET_MESSAGE',
